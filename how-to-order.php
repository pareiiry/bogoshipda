...
<head>
    <title>Bogoshipda | ขั้นตอนการสั่งซื้อ</title>
    <meta charset="UTF-8">
...
<div class="row">
    ...
    <h3 class="panel-title">ขั้นตอนการสั่งซื้อ</h3>
</div>
<div class="panel-body">
    1. เลือกสินค้า หรือ ออกแบบสินค้า
    <br>2. ในหน้าสั่งตะกร้าสินค้า สามารถแก้ไขรายละเอียดรายการสั่งซื้อและจำนวนการสั่งซื้อได้
    <br>3. เมื่อตรวจสอบรายละเอียดรายการสั่งซื้อครบถ้วนแล้ว เลือกวิธีการจัดส่ง กรอกข้อมูลรายละเอียดของผู้รับสินค้าและรายละเอียดติดต่อ
    <br>4. เมื่อกรอกข้อมูลเสร็จเรียบร้อยแล้วกดปุ่ม <b style="color: #ffaeba">“ดำเนินการต่อ”</b>
    <br>5. ระบบจะทำสรุปรายการสั่งซื้อสินค้า และแจ้งรายละเอียดใบสั่งซื้อสินค้า
    <br>6. เมื่อตรวจสอบข้อมูลแล้ว กดปุ่ม <b style="color: #ffaeba">"สั่งซื้อสินค้า" </b>
</div>
    </div>
    </div>
        </div>
