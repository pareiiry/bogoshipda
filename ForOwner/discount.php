...
if(!isset($_GET['page'])){
    $sql2 = "SELECT * FROM code ORDER BY dateCreate DESC LIMIT $pageshow,10";
    $result2 = mysqli_query($con, $sql2);

    $sql3 = "SELECT * FROM code ORDER BY dateCreate DESC";
...
<html lang="en">
<head>
    <title>Bogoshipda Admin | ส่วนลด</title>
    <meta charset="utf-8">
                    ...
                    ";
                                ...
                                <div class="pagination flex-m flex-w p-t-26">
                                    ...
                                    for($pn=1;$pn<=$page_of_pd;$pn++){
                                        ...
                                        echo  "<a href=\"discount.php?page=$pn\" class=\"item-pagination flex-c-m trans-0-4\">$pn</a>";
