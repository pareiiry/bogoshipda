...
<html lang="en">
<head>
    <title>Bogoshipda Admin | บัญชีรับเงิน</title>
    <meta charset="utf-8">
...
<div class="w3-sidebar w3-bar-block" style="width:25%;background-color:#4f4f4f;color: white;padding: 15px;" >
    ...
    <div class="container-fluid bg-3 text-center">
        <div class="row">
            ...
            <div class="col-sm-3">
                <!--                        <p>Some text..</p>-->
                <a href="bank.php"><img class="bg-icon-current" src="../img/menu_bar_admin/account.png" style="width:100%" alt="Image">บัญชี</a>
            </div>
            <div class="col-sm-3">
                <!--                        <p>Some text..</p>-->
