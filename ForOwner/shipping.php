        ...
        <div class="col-sm-9">
            ...
            <table id="myTable" >
                <tr class="header">
                    ...
                    <th style="width:35%;text-align:center;">รายละเอียดการส่งของ</th>
                    <th style="width: 15%; text-align: center;">รหัสพัสดุ</th>
                    <th style="width:20%; text-align: center;">ยืนยันจัดส่ง</th>
                </tr>
                <?php
                $howShip="";
                $orderStatus="";
                ...
                echo "<tr>
                    ...
                    <td style=\"text-align: center;\"><input type='text' class='form-control' value='' name='trackingNumber' placeholder='ระบุรหัสพัสดุ...' required></td>
